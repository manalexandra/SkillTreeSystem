/*
  # Multiple Users Complete Trees

  1. Changes
    - Creates completed_trees table to track multiple user completions
    - Adds RLS policies for security
    - Adds function to check tree completion status

  2. Security
    - Enables RLS
    - Adds policies for viewing and inserting completions
    - Uses security definer for completion check function
*/
