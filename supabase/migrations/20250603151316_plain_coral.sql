/*
  ...
  2. Changes
    - Added description_html to skill_nodes table
  
  3. Security
    - RLS policies for all new tables
    - Secure access patterns for managers and users
  
  4. Functions
    - Progress calculation for nested nodes
*/
...
CREATE POLICY "Users can modify progress"
  ON node_progress
  FOR UPDATE
  TO authenticated
