/*
  ...
  1. Changes
    - Create function for secure role checking
    - Drop existing policies
    - Create new policies using the function
    
  2. Security
    - Add SECURITY DEFINER to ensure function runs with elevated privileges
    - Update policies to use function instead of direct table access
*/
