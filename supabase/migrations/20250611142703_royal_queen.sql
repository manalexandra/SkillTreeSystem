/*
  # Rich Text Editor Database Schema

  1. New Tables
    - `node_content` - Stores rich text content with versioning
    - `node_images` - Tracks uploaded images for nodes
    - `content_versions` - Version history for content changes

  2. Changes
    - Add rich content fields to skill_nodes
    - Add metadata fields for SEO and content management
    - Add content sanitization and validation

  3. Security
    - Enable RLS on all new tables
    - Add policies for content management
    - Implement XSS protection through sanitization
*/
